 ...
 * @author joban
 */
public class vistaImprimirExp extends javax.swing.JFrame {
    private DefaultListModel listModel;
    /**
     * Creates new form vistaImprimirExp
     */
    public vistaImprimirExp() {
        initComponents();
    ...
    public void mostraExp() {
        ...
        /*
        try {
            ArrayList<String> a = cPresentacion.getArrayExp();
            //a.add("prueba");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Expressions guardades:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaImprimirExp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaImprimirExp().setVisible(true);
            }
        });
    }
